  ...
  return (
    <div className="text-white/70 pt-6">
            ...
            <li>
                <a href="#contact" className="group">
                    ...
                    <div className="relative">
                        <div className="absolute w-2/3 h-1 transition-all duration-300 ease-out bg-orange-400 
                        rounded-full group-hover:w-full"></div>
       ...
       <motion.div
        ...
        >
            <ul className="text-4xl fontt=-semibold my-24 text-center space-y-4
        8">
                {navLinks.map ((link,index)=>(
                    <li key={index}>
